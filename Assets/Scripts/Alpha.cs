...
public static class Alpha
{
    ...
    public static async void On(GameObject image, int delay = 1, Action callback = null, int sA = 0, int eA = 255, bool destroy = false, bool sActive = true, bool eActive = true)
    {
    ...
    public static async void Off(GameObject image, int delay = 1, Action callback = null, int sA = 255, int eA = 0, bool destroy = false, bool sActive = true, bool eActive = true)
    {
        image.SetActive(sActive);
        float time = Time.time * 1000;
        while (sA > eA)
